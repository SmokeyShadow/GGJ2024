...
namespace GGJ2024_GiggleTeddy
{
    public class Piece : MonoBehaviour
    {
        ...
        [SerializeField]
        private float torqueMultiplier = 50;
        [SerializeField]
        private Vector2 shardSpeedMultiplier = new Vector2(150, 500);
        [SerializeField]
        private float fadingSpeed = 1f;
        [SerializeField]
        private float startFadingAfterSeconds = 5f;
        #endregion
